...
function startCalculator() {
    ...
    document.addEventListener('keydown', function(event) {
      if (event.key == '0') {
        document.getElementById('num-0').click();
      }
      else if (event.key == '1') {
        document.getElementById('num-1').click();
      }
      else if (event.key == '2') {
        document.getElementById('num-2').click();
      }
      else if (event.key == '3') {
        document.getElementById('num-3').click();
      }
      else if (event.key == '4') {
        document.getElementById('num-4').click();
      }
      else if (event.key == '5') {
        document.getElementById('num-5').click();
      }
      else if (event.key == '6') {
        document.getElementById('num-6').click();
      }
      else if (event.key == '7') {
        document.getElementById('num-7').click();
      }
      else if (event.key == '8') {
        document.getElementById('num-8').click();
      }
      else if (event.key == '9') {
